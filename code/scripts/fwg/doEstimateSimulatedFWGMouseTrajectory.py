...
def main(argv):
    ...
    vars_to_estimate = {"sigma_a": True, "R": True, "m0": True, "V0": True}
    R, m0, V0, sigma_a = learning.em_SS_tracking_DWPA(y=simRes["y"], B=simRes["B"], sigma_a0=sigma_ax0, Qt=simRes["Qt"], Z=simRes["Z"], R_0=R_0, m0_0=m0_0, V0_0=V0_0, vars_to_estimate=vars_to_estimate, max_iter=em_max_iter)
    ...
    # optim_res = learning.optim_SS_tracking_DWPA_diagV0(y=simRes["y"], B=simRes["B"], sigma_ax0=sigma_ax0, sigma_ay0=sigma_ay0, Qt=simRes["Qt"], Z=simRes["Z"], sqrt_diag_R_0=sqrt_diag_R_0, m0_0=m0_0, sqrt_diag_V0_0=sqrt_diag_V0_0, max_iter=em_max_iter)
