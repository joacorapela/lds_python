...
def main(argv):
    ...
    vars_to_estimate = {"sigma_a": True, "R": False, "m0": False, "V0": False}
    R, m0, V0, sigma_a = learning.em_SS_tracking_DWPA(y=simRes["y"], B=simRes["B"], sigma_a0=sigma_a0, Qe=simRes["Qe"], Z=simRes["Z"], R_0=R_0, m0_0=m0_0, V0_0=V0_0, vars_to_estimate=vars_to_estimate, max_iter=em_max_iter)
