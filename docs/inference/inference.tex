...
We added little amount of noise to simulated states to generate
measurements.
%
We observed that the finite difference method was very sensitive to this noise.
%
The Kalman filter and smoother were robust to this noise.
